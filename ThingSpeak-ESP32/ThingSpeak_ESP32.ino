...
#define SECRET_SSID "Laura"		
#define SECRET_PASS "laurinha"	

#define SECRET_CH_ID 2902513 //	Preencha o número do seu canal do ThingSpeak	
#define SECRET_WRITE_APIKEY "CEM4423Z4W8IER90"   // Preencha a API Key do seu canal
